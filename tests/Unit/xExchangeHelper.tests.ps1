...
try
{
    InModuleScope $script:subModuleName {
        ...
        Describe 'xExchangeHelper\Get-LocalizedData' -Tag 'Helper' {
            $mockTestPath = {
        ...
        Describe 'xExchangeHelper\ConvertTo-HashTable' -Tag 'Helper' {
        ...
        Describe 'xExchangeHelper\Remove-CommonParameter' -Tag 'Helper' {
        ...
        Describe 'xExchangeHelper\New-InvalidArgumentException' -Tag 'Helper' {
        ...
        Describe 'xExchangeHelper\Test-DscParameterState' -Tag 'Helper' {
            $verbose = $true
        ...
        Describe 'xExchangeHelper\Test-DscObjectHasProperty' -Tag 'Helper' {
